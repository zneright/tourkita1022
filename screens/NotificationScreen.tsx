                    ...
                    {loading ? (
                        Array.from({ length: 5 }).map((_, i) => (
                            <View key={i} style={{ marginBottom: 16 }}>
                                <SkeletonBox width="100%" height={70} borderRadius={12} style={{ marginBottom: 8 }} />
                                <SkeletonBox width="80%" height={14} borderRadius={6} style={{ marginBottom: 4, marginLeft: 16 }} />
                                <SkeletonBox width="60%" height={14} borderRadius={6} style={{ marginLeft: 16 }} />
                            </View>
                        ))
