...
const EventDetailModal: React.FC<Props> = ({ visible, onClose, event }) => {
    ...
    const handleNavigate = async () => {
        try {
            ...
            if (target) {
                setSelectedLandmark(target); // will auto-open modal in MapScreen
...
const styles = StyleSheet.create({
    ...
    addressCard: {},
    infoText: { fontSize: 13, color: "#555", marginLeft: 8 },
    ...
    navigateButton: { backgroundColor: "#2c3e50", paddingVertical: 14, paddingHorizontal: 24, borderRadius: 12, width: "100%", alignItems: "center" },
