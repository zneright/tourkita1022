                ...
                {loadingSheet ? (
                    ...
                    <html>
                        <head>
                            ...
                            <style>
                                body { font-size: 16px; color: #4E342E; line-height: 1.5; font-family: sans-serif; padding: 0; margin: 0; }
                                a { color: #007AFF; text-decoration: underline; }
                            </style>
                        </head>
                        <body>
                            ${selectedLandmark.description ? selectedLandmark.description.replace(/\n/g, "<br>") : "No description provided."}
                        </body>
                    </html>
                `
                                    }}
