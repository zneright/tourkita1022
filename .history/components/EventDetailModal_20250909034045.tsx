...
const EventDetailModal: React.FC<Props> = ({ visible, onClose, event }) => {
    ...
    const handleNavigate = async () => {
        try {
            ...
            // Prefer customAddress with coordinates
            if (event.customAddress?.latitude && event.customAddress?.longitude) {
                const target = {
                    ...
                    <ScrollView contentContainerStyle={styles.content}>
                        ...
                        <View style={[styles.cardBase, styles.infoCard]}>
                            ...
                            <Text style={styles.infoText} numberOfLines={2}>
                                {event.customAddress?.label ? event.customAddress.label : event.address}
                            </Text>
