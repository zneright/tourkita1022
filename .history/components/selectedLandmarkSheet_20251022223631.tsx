...
export default function SelectedLandmarkSheet() {
  ...
  const styles = StyleSheet.create({
    ...
    arButtonContainer: {
        flexDirection: 'row',
        justifyContent: 'space-around', // This lines them up side-by-side
        alignItems: 'center',
        marginTop: 10,
    },
    buttonWrapper: {
        alignItems: 'center', // Centers the Lottie animation and button vertically
    },
    lottie: {
        width: 150,
        height: 150,
    },
    // ... rest of your stylesconst styles = StyleSheet.create({
    // ... your existing styles
    buttonText: {
        color: "#fff",
        fontWeight: "bold",
