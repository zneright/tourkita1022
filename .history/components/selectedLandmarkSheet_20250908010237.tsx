...
export default function SelectedLandmarkSheet() {
        ...
        try {
            ...
            snapshot.forEach(docSnap => {
                ...
                eventsForWeek.push({
                    ...
                    start: event.eventStartTime || "12:00 AM",
                    end: event.eventEndTime || "11:59 PM",
                ...
                const start = parseTimeToMinutes(event.eventStartTime) ?? 0;
                const end = parseTimeToMinutes(event.eventEndTime) ?? 24 * 60;
    ...
    const isOpenToday = () => {
        ...
        // 24-hour open check
        if (hoursToday.open === "12:00 AM" && hoursToday.close === "11:59 PM") return true;
                        ...
                        <View style={styles.section}>
                            ...
                            {(() => {
                                ...
                                const formatHours = (data?: { open?: string; close?: string; closed?: boolean }) => {
                                    ...
                                    const openMinutes = parseTimeToMinutes(data.open);
                                    const closeMinutes = parseTimeToMinutes(data.close);

                                    if (openMinutes === 0 && closeMinutes === 1439) return "Open 24 hours"; // 0 = 12:00 AM, 1439 = 11:59 PM
