...
export default function LandmarkMarkers({ selectedCategory, onLoadingChange }: any) {
    ...
    const onPointPress = async (event: OnPressEvent) => {
        try {
            ...
            if (isEvent) {
                if (hasCustomAddress) {
                    // Navigate to its lat/lng instead of opening modal
                    // You can use your map navigation function here
                    navigateToLocation(parseFloat(landmark.latitude), parseFloat(landmark.longitude));
                    return;
                }
