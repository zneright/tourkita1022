        ...
        const fetchEvents = async () => {
            ...
            try {
                ...
                eventSnap.forEach((doc) => {
                    ...
                    // Use startDate or fallback to "date" field
                    ...
                    let eventStart: Date;
                    try {
                        eventStart = parseISO(rawDate);
                    } catch {
                        eventStart = new Date(rawDate); // fallback
                    }

                    const eventStart = toLocalDate(rawDate);
