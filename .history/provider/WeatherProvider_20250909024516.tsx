        ...
        <View style={styles.weatherButton}>
            ...
            <Animated.View style={[styles.weatherInfo, animatedWeatherStyle]}>
                <BlurView
                    ...
                    blurType="light"
                    blurAmount={15}
                    reducedTransparencyFallbackColor="#f5f5dc"
                />
                {isLoading ? (
                    <ActivityIndicator size="large" color="#c49b66" />
                ) : (
                    <>
...
const styles = StyleSheet.create({
    ...
    weatherIcon: {
        ...
        resizeMode: "contain",
        borderRadius: 30,
        backgroundColor: "#f5f5dc", // beige background for TourKita theme
        padding: 10,
        elevation: 5,
    },
    weatherInfo: {
    ...
    hourCard: {
        backgroundColor: "rgba(196, 155, 102, 0.15)", // light gold transparency
        padding: 12,
        borderRadius: 15,
        marginRight: 10,
        alignItems: "center",
