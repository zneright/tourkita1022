...
const SignUpScreen = () => {
    ...
    const [contactNumberTaken, setContactNumberTaken] = useState(false);
    ...
    const isContactNumberTaken = async (number: string): Promise<boolean> => {
        const usersRef = collection(db, "users");
        const q = query(usersRef, where("contactNumber", "==", number));
    ...
    const handleNext = async () => {
        ...
        const contactTaken = await isContactNumberTaken(contactNumber);
        if (contactTaken) {
            setContactNumberTaken(true);
        ...
        try {
            const contactTaken = await isContactNumberTaken(contactNumber);
            if (contactTaken) {
                Alert.alert("Error", "This contact number is already registered.");
                setIsSubmitting(false);
                return;
            }
                ...
                <View style={styles.formCard}>
                    ...
                    <View style={styles.row}>
                        ...
                        <View style={styles.column}>
                            ...
                            <TextInput
                                style={[styles.input, (errors.contactNumber || contactNumberTaken) && styles.errorInput]}
                            ...
                            {contactNumberTaken && <Text style={styles.errorText}>This contact number is already registered.</Text>}
                        </View>
