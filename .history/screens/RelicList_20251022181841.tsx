...
import Button from '../components/Button'; // Step 1: Import the Button component

export default function View3D({ route, navigation }) { // Step 2: Add navigation prop
    ...
    // Construct the predictable local URI using the shared directory structure
    ...
    return (
        <View style={styles.container}>
            <Button />{/* Step 3: Add the Button component to the layout */}
...
const styles = StyleSheet.create({
    container: { flex: 1, backgroundColor: '#F9F4EF', padding: 16 }, // Changed paddingTop to padding
    modelView: { width: '100%', height: 500 },
    centered: { justifyContent: 'center', alignItems: 'center' },
    title: {
        marginTop: 45, // Added margin to push title down
        fontSize: 22,
        fontWeight: 'bold',
        color: '#4E342E',
        marginBottom: 10,
