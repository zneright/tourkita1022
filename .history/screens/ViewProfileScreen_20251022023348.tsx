...
export default function ViewProfileScreen() {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            setLoading(true);
            try {
                // Prioritize fetching fresh data from Firestore
                const auth = getAuth();
                ...
                console.error('Error fetching from Firestore, trying cache:', error);
                // If Firestore fails (e.g., offline), fall back to cache
                try {
    ...
    // Add icons to each field for better UI
