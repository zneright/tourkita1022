...
// Helper to get styled info for each category
...
// A dedicated component for each notification item
    ...
    const fetchNotifications = async () => {
        ...
        try {
            ...
            const notifData: Notification[] = notifSnap.docs
                .map(docSnap => { /* ... (same as your original mapping) ... */ })
                .filter(n => { /* ... (same as your original filtering) ... */ });
            ...
            setLoading(false); // Always stop loading in the end
        }
    };
...
const styles = StyleSheet.create({
    ...
    centerView: { flex: 1, justifyContent: "center", alignItems: "center", marginTop: 80 },
