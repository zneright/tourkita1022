    ...
    return (
        <SafeAreaView style={styles.container}>
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <FormInput label="Middle Initial" value={formData.middleInitial} onChange={(v) => handleInputChange("middleInitial", v)} placeholder="No Middle Initial" />
                ...
                <FormPicker
                    ...
                    items={[
                        ...
                        { label: "Foreign National", value: "Local" },
                ...
                <FormPicker
                    ...
                    items={[
                        ...
                        { label: "Non-Binary", value: "Non-Ninary" },
