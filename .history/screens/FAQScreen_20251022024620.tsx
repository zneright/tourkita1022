...
// A dedicated component for each FAQ item for better organization
...
// A skeleton loader component that mimics the final layout
...
const FAQScreen = () => {
    ...
    const toggleFAQ = (index: number) => {
        // Apply a smooth animation when the layout changes
