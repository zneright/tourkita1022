...
export default function ViewProfileScreen() {
    ...
    const fetchUserData = async () => {
        ...
        // 2. Then, fetch fresh data from Firestore to update the UI and cache.
        try {
            const auth = getAuth();
            ...
            // If Firestore fails and we still have no data, stop loading
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                <View style={styles.headerCard}>
                    <View style={styles.avatarContainer}>
                        {loading && !userData ? ( // Show skeleton only on initial load
...
const styles = StyleSheet.create({
    ...
    name: { fontSize: 24, fontWeight: 'bold', color: '#4E342E' },
